                ...
                <div className='p-2 sm:p-4'>
                    {isLoading ? (
                        ...
                        <div className='relative w-full rounded-lg overflow-hidden shadow-md border border-slate-200 transition-all duration-300'>
                            <iframe title="Cloudperformance2.0" width="1280" height="2100" src="https://app.powerbi.com/view?r=eyJrIjoiZTNjOGY4MjYtYjc1Ni00MDNkLTg1ZTMtY2ExMWIyNmU0NTMwIiwidCI6IjdiYjNlMTQ3LWQxZTgtNDQ4Yy05NGE0LTUyNjQyZGQ1ZGQ4ZCIsImMiOjR9&pageName=d201fbd6fcf6c567bd14" className='w-full h-[1280px] sm:h-[1800px] md:h-[2300px]' style={{ clipPath: "inset(0px 0px 53px 0px)" }} frameBorder="0" allowFullScreen={true}></iframe>
                        </div>
