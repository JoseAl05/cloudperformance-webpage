    ...
    <>
      ...
      <div
        className={cn(
          ...
          isExpanded ? "w-64 bg-white" : "w-16 bg-white",
        )}
      >
                ...
                {isExpanded ? (
                  <>
                    <Link
                      href={route.href}
                      className={cn(
                        "flex items-center px-4 py-2 w-full text-slate-800 hover:text-slate-400 transition-colors",
                        pathname === route.href && "text-slate-400 bg-gray-200",
