                    ...
                    {showInfo && (
                        <div className='mt-3 sm:mt-4 p-3 sm:p-4 bg-slate-100 rounded-lg border border-slate-200 animate-fadeIn'>
                            <p className='text-slate-700 text-xs sm:text-sm leading-relaxed'>
                                Esta visualización muestra un detalle completo de una máquina virtual seleccionada: sus características, deployments asociados, costos (fijos y por uso), medidas facturadas y detalles de cada facturación.
                            </p>
                        </div>
                    )}
                </div>
                ...
                <div className='p-2 sm:p-4'>
                    {isLoading ? (
                        ...
                        <div className='relative w-full rounded-lg overflow-hidden shadow-md border border-slate-200 transition-all duration-300'>
                            <iframe title="Cloudperformance2.0" width="1280" height="2100" src="https://app.powerbi.com/view?r=eyJrIjoiZGJmMjBlZWQtOGVhNC00YmZhLTliNjktZjU1MmU2YzNmOGVhIiwidCI6IjdiYjNlMTQ3LWQxZTgtNDQ4Yy05NGE0LTUyNjQyZGQ1ZGQ4ZCIsImMiOjR9&pageName=bb7da14974bdde50c296" className='w-full h-[1280px] sm:h-[1800px] md:h-[2300px]' style={{ clipPath: "inset(0px 0px 53px 0px)" }} frameBorder="0" allowFullScreen={true}></iframe>
                        </div>
