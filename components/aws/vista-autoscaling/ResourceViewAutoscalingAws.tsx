...
export const ResourceViewAutoscalingAws = () => {
                    ...
                    {isLoading ? (
                        ...
                        <div className='relative w-full rounded-lg overflow-hidden shadow-md border border-slate-200 transition-all duration-300'>
                            ...
                            {/* <iframe
                                ...
                                width="1280"
                                height="2100"
                                src="https://app.powerbi.com/view?r=eyJrIjoiNmY5NmNmZWUtNWE1ZS00MDMxLWE0ZjQtYmEwZGM1NDk3ZTY5IiwidCI6IjdiYjNlMTQ3LWQxZTgtNDQ4Yy05NGE0LTUyNjQyZGQ1ZGQ4ZCIsImMiOjR9&pageName=ee28a3a5856b08b34856"
                                className='w-full h-[300vh] sm:h-[320vh] md:h-[380vh]'
                                style={{ clipPath: "inset(0px 0px 53px 0px)" }}
                                frameBorder="0"
                                allowFullScreen={true}
