...
export const FunctionViewTopResourcesCostByInstanceFamilyAws = () => {
                    ...
                    {isLoading ? (
                        ...
                        <div className='relative w-full rounded-lg overflow-hidden shadow-md border border-slate-200 transition-all duration-300'>
                            <iframe
                                ...
                                width='1280'
                                height='720'
                                src="https://app.powerbi.com/view?r=eyJrIjoiNmY5NmNmZWUtNWE1ZS00MDMxLWE0ZjQtYmEwZGM1NDk3ZTY5IiwidCI6IjdiYjNlMTQ3LWQxZTgtNDQ4Yy05NGE0LTUyNjQyZGQ1ZGQ4ZCIsImMiOjR9&pageName=1d965022c0a24bb18b1e"
