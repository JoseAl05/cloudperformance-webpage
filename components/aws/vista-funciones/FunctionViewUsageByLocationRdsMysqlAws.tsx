...
export const FunctionViewUsageByLocationRdsMysqlAws = () => {
                    ...
                    {isLoading ? (
                        ...
                        <div className='relative w-full rounded-lg overflow-hidden shadow-md border border-slate-200 transition-all duration-300'>
                            <iframe
                                ...
                                width='1280'
                                height='720'
                                src="https://app.powerbi.com/view?r=eyJrIjoiMzYzZWQxZTgtNDBlNy00MWJhLTgxMjctZGVjYzEyYWRjN2YxIiwidCI6IjdiYjNlMTQ3LWQxZTgtNDQ4Yy05NGE0LTUyNjQyZGQ1ZGQ4ZCIsImMiOjR9&pageName=a7f4792a67a4741b7ea5"
                            ...
                            {/* <iframe
                                ...
                                width='1280'
                                height='720'
                                src="https://app.powerbi.com/view?r=eyJrIjoiNmY5NmNmZWUtNWE1ZS00MDMxLWE0ZjQtYmEwZGM1NDk3ZTY5IiwidCI6IjdiYjNlMTQ3LWQxZTgtNDQ4Yy05NGE0LTUyNjQyZGQ1ZGQ4ZCIsImMiOjR9&pageName=a7f4792a67a4741b7ea5"
                                className='w-full h-[70vh] sm:h-[80vh] md:h-[140vh]'
                                style={{ clipPath: 'inset(0px 0px 53px 0px)' }}
                                frameBorder='0'
                                allowFullScreen={true}
