...
export const FunctionViewUsageEc2EksOpenClosedHoursAws = () => {
                    ...
                    <div className='flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 sm:gap-0'>
                        <div className='flex items-center gap-2 sm:gap-3'>
                            ...
                            <h2 className='text-slate-800 text-xl sm:text-2xl font-bold'>
                                Análisis consumo Instancias EC2 Nodos de EKS horario Hábil y No Hábil
                            </h2>
                        </div>
                        <button
                    ...
                    {showInfo && (
                        <div className='mt-3 sm:mt-4 p-3 sm:p-4 bg-slate-100 rounded-lg border border-slate-200 animate-fadeIn'>
                            <p className='text-slate-700 text-xs sm:text-sm leading-relaxed'>
                                Esta visualización muestra el comportamiento de Instancias EC2 que pertenecen a clusters EKS en horario hábil (Lunes a Viernes desde 8:00 AM hasta 18:00 PM) y horario no hábil (Sabado y Domingo desde 18:00 PM hasta 8:00 AM).
                            </p>
                        </div>
                    )}
                </div>
                    ...
                    {isLoading ? (
                        ...
                        <div className='relative w-full rounded-lg overflow-hidden shadow-md border border-slate-200 transition-all duration-300'>
                            <iframe
                                ...
                                width='1280'
                                height='720'
                                src="https://app.powerbi.com/view?r=eyJrIjoiNmY5NmNmZWUtNWE1ZS00MDMxLWE0ZjQtYmEwZGM1NDk3ZTY5IiwidCI6IjdiYjNlMTQ3LWQxZTgtNDQ4Yy05NGE0LTUyNjQyZGQ1ZGQ4ZCIsImMiOjR9&pageName=4d54e19f3242648e5dbe"
