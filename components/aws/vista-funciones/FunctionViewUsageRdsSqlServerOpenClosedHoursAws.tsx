...
export const FunctionViewUsageRdsSqlServerOpenClosedHoursAws = () => {
                    ...
                    <div className='flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 sm:gap-0'>
                        <div className='flex items-center gap-2 sm:gap-3'>
                            ...
                            <h2 className='text-slate-800 text-xl sm:text-2xl font-bold'>
                                Análisis consumo Instancias RDS Sql Server horario Hábil y No Hábil
                            </h2>
                        </div>
                        <button
                    ...
                    {showInfo && (
                        <div className='mt-3 sm:mt-4 p-3 sm:p-4 bg-slate-100 rounded-lg border border-slate-200 animate-fadeIn'>
                            <p className='text-slate-700 text-xs sm:text-sm leading-relaxed'>
                                Esta visualización muestra el comportamiento de RDS Sql Server en horario hábil (Lunes a Viernes desde 8:00 AM hasta 18:00 PM) y horario no hábil (Sabado y Domingo desde 18:00 PM hasta 8:00 AM).
                            </p>
                        </div>
                    )}
                </div>
                    ...
                    {isLoading ? (
                        ...
                        <div className='relative w-full rounded-lg overflow-hidden shadow-md border border-slate-200 transition-all duration-300'>
                            <iframe
                                ...
                                width='1280'
                                height='720'
                                src="https://app.powerbi.com/view?r=eyJrIjoiMzYzZWQxZTgtNDBlNy00MWJhLTgxMjctZGVjYzEyYWRjN2YxIiwidCI6IjdiYjNlMTQ3LWQxZTgtNDQ4Yy05NGE0LTUyNjQyZGQ1ZGQ4ZCIsImMiOjR9&pageName=2d378d7f2e7bd1085e89"
