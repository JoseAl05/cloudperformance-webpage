...
export const ConsumeViewRdsPostgresqlAws = () => {
                    ...
                    {showInfo && (
                        <div className='mt-3 sm:mt-4 p-3 sm:p-4 bg-slate-100 rounded-lg border border-slate-200 animate-fadeIn'>
                            <p className='text-slate-700 text-xs sm:text-sm leading-relaxed'>
                                Estas visualizaciones muestran los consumos y no consumos de Instancias RDS Postgresql.
                            </p>
                        </div>
                    )}
                </div>
                    ...
                    {isLoading ? (
                        ...
                        <div className='relative w-full rounded-lg overflow-hidden shadow-md border border-slate-200 transition-all duration-300'>
                            <iframe
                                ...
                                width='1280'
                                height='720'
                                src="https://app.powerbi.com/view?r=eyJrIjoiMzYzZWQxZTgtNDBlNy00MWJhLTgxMjctZGVjYzEyYWRjN2YxIiwidCI6IjdiYjNlMTQ3LWQxZTgtNDQ4Yy05NGE0LTUyNjQyZGQ1ZGQ4ZCIsImMiOjR9&pageName=bd79554a0c5248f18c57"
                            ...
                            {/* <iframe
                                ...
                                width='1280'
                                height='720'
                                src="https://app.powerbi.com/view?r=eyJrIjoiNmY5NmNmZWUtNWE1ZS00MDMxLWE0ZjQtYmEwZGM1NDk3ZTY5IiwidCI6IjdiYjNlMTQ3LWQxZTgtNDQ4Yy05NGE0LTUyNjQyZGQ1ZGQ4ZCIsImMiOjR9&pageName=bd79554a0c5248f18c57"
